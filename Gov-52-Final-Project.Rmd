...
Rogowski^[Olson, Michael P, & Rogowski, Jon C. (2020). Legislative Term Limits and Polarization. The Journal of Politics, 82(2), 572-586.] explore the causal impact of the adoption of legislative term limits on
...
behavior on an ideological scale from 0-3 with three being the most polarized.
Then, these individual scores are aggregated to create a legislative
...
caused by these dummy variables. The effects of state and year are held constant
which allows the authors to sort out the effect of these variables. The main
...
The conclusions of this paper are limited by a variety of factors. The first of
which is that the main outcome variable, legislative polarization, is constant
over the course of a legislators career. This means that individual level
...
research could be voter's responses to term limits. This research could answer
